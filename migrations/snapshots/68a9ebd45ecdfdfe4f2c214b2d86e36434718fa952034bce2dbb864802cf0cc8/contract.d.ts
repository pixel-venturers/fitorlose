...
export type StorageHash =
  StorageHashBase<'68a9ebd45ecdfdfe4f2c214b2d86e36434718fa952034bce2dbb864802cf0cc8'>;
export type ExecutionHash =
  ExecutionHashBase<'ef7b71e85134f6ab5e2f4b15c47de571eee3bfc22e3227bc347133b5c7df96f5'>;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ShareRecord: {
      ...
      readonly shareType: CodecTypes['pg/text@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly shareRecord: {
              ...
              indexes: readonly [
                {
                  readonly name: 'shareRecord_challengeId_idx_73b8115d';
                  readonly prefix: 'shareRecord_challengeId_idx';
                  readonly columns: readonly ['challengeId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'shareRecord_userId_idx_a489d58a';
                  readonly prefix: 'shareRecord_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'shareRecord';
                    readonly columns: readonly ['challengeId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            ...
            readonly PaymentProvider: {
              readonly kind: 'valueSet';
              readonly values: readonly ['DODO', 'PAYU'];
            };
      ...
      readonly public: {
          ...
          readonly ShareRecord: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly shareType: { readonly column: 'shareType' };
        ...
        readonly enum: {
          ...
          readonly PaymentProvider: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'DODO'; readonly value: 'DODO' },
              { readonly name: 'PAYU'; readonly value: 'PAYU' },
            ];
          };
          readonly PaymentStatus: {
            readonly codecId: 'pg/text@1';
