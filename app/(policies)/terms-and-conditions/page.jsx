export default function Page() {
  return (
    <>
      ...
      <p>Welcome to FitorLose!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of FitorLose&apos;s Website, located at https://fitorlose.lol.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use FitorLose if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing FitorLose, you agreed to use
        cookies in agreement with the FitorLose&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, FitorLose and/or its licensors own the
        intellectual property rights for all material on FitorLose. All
        intellectual property rights are reserved. You may access this from
        FitorLose for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from FitorLose</li>
        <li>Sell, rent or sub-license material from FitorLose</li>
        <li>Reproduce, duplicate or copy material from FitorLose</li>
        <li>Redistribute content from FitorLose</li>
      </ul>
      <p>
      ...
      <p>
        ...
        FitorLose does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of FitorLose, its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, FitorLose shall not be
      ...
      <p>
        FitorLose reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant FitorLose a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        absence of FitorLose; and (d) the link is in the context of general
      ...
      <p>
        ...
        e-mail to FitorLose. Please include your name, your organization name,
      ...
      <p>
        No use of FitorLose&apos;s logo or other artwork will be allowed for
